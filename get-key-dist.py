...
def main():
    ...
    if len(sys.argv) < 4:
        print("Usage: python get-key-dist.py <csv_file> <min_key> <max_key> [num_buckets]")
    ...
    try:
        result = subprocess.run([count_key_binary, filename, str(min_key), str(max_key), str(num_buckets)], 
